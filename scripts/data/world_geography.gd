...
## lobes belonging to one named system overlap into continuous belts, basins and
## coasts. Panel IDs locate authoring anchors; they do not define the edge of a
## landform or a political territory.
const LANDFORM_LOBES := [
	# Landavol drainage basin: broad, low and connected across L1-L3. The basin
	# stays lower than Xérvu/Taktikã; four seam transition lobes below carry the
	# surrounding physical land to its neighbouring systems without making the
	# Landavol political footprint coastal.
	...
	# Ĭspayk is a tiny polity, but its storm-track volcanic islands are literal
	# land beneath the political footprint rather than icons floating on ocean.
	...
	# Pāwa: deliberately an OPEN chain, not a ring.
	...
	# P3 is mostly sea plus a substantial unnamed arid outer coast. A'ace occupies
	# only a tiny reclaimed part of this coast in the political layer.
	{"system":"outer_dry_coast","panel":"P3","uv":Vector2(0.33,0.72),"radius":0.34,"elev":0.55,"moisture":-0.30,"temp":0.12},
	{"system":"outer_dry_coast","panel":"P3","uv":Vector2(0.55,0.72),"radius":0.40,"elev":0.60,"moisture":-0.34,"temp":0.14},
	{"system":"outer_dry_coast","panel":"P3","uv":Vector2(0.76,0.69),"radius":0.34,"elev":0.54,"moisture":-0.30,"temp":0.12},

	# Seven locked physical core contacts. These are deliberately broad terrain
	# transitions rather than pinprick bridges. Their centres sit exactly on the
	# paired macro seams, so the same lobe exists on both sides after folding.
	{"system":"landavol_speddigh_upland","face":"L","edge":"u_min","t":-0.35,"radius":0.50,"elev":0.60,"moisture":0.12,"temp":-0.15},
	{"system":"landavol_bloc_lowland","face":"L","edge":"v_max","t":-0.18,"radius":0.52,"elev":0.42,"moisture":0.26,"temp":0.02},
	{"system":"landavol_xervu_escarpment","face":"L","edge":"u_max","t":0.15,"radius":0.50,"elev":0.62,"moisture":-0.12,"temp":0.02},
	{"system":"landavol_pawa_transition","face":"L","edge":"v_min","t":0.25,"radius":0.52,"elev":0.48,"moisture":0.12,"temp":0.05},
	{"system":"bloc_xervu_coastal_highland","face":"B","edge":"v_max","t":0.34,"radius":0.42,"elev":0.54,"moisture":0.02,"temp":0.00},
	{"system":"xervu_taktika_plateau","face":"X","edge":"v_min","t":0.20,"radius":0.48,"elev":0.72,"moisture":-0.28,"temp":-0.18},
	{"system":"speddigh_taktika_upland","face":"S","edge":"v_min","t":-0.10,"radius":0.48,"elev":0.70,"moisture":0.02,"temp":-0.26},
]
