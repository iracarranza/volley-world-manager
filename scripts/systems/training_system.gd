...
const ACTIVITIES := {
	...
	"Serve Receive": {"attributes": ["reception", "reception_balance", "reception_stability"], "fatigue": 0.055, "morale": 0.005, "familiarity": 0.02,
		"description": "Train platform control, movement balance and stability under pace."},
	"Attack & Transition": {"attributes": ["attack_power", "attack_accuracy", "approach_timing", "transition_speed"], "fatigue": 0.08, "morale": 0.005, "familiarity": 0.02,
		"description": "Improve transition speed, approach timing and terminal attacking."},
	"Blocking & Defense": {"attributes": ["block_timing", "anticipation", "lateral_speed"], "fatigue": 0.07, "morale": 0.0, "familiarity": 0.025,
