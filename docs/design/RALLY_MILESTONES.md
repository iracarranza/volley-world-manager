...
| **M4 — physical platform contact** | **IN PROGRESS / EVIDENCE BLOCKED** | Reception, controlled dig, emergency dig and attack coverage produce an outgoing ball from incoming ball + body/contact state + intent/selection + execution, not from event-specific apex bands. Intent publication, shipped-model transfer characterization and controlled attribute leverage are done. T1/T2 lack measured magnitudes; T3 has only an aggregate order-of-magnitude bound. | [`PLATFORM_CONTACT.md`](PLATFORM_CONTACT.md), [`PLATFORM_INTENT.md`](../review/PLATFORM_INTENT.md), [`PLATFORM_TRANSFER.md`](../review/PLATFORM_TRANSFER.md), [`PLATFORM_ATTRIBUTE_LEVERAGE.md`](../review/PLATFORM_ATTRIBUTE_LEVERAGE.md), [`PLATFORM_PHYSICS_EVIDENCE_GAP.md`](../review/PLATFORM_PHYSICS_EVIDENCE_GAP.md) |
