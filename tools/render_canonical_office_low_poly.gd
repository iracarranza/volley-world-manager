extends SceneTree
## Render harness for the first modeled canonical office pass.
## Writes seven PNGs to artifacts/canonical-office-low-poly/.

const OFFICE := preload("res://scenes/office/canonical_office_low_poly.tscn")
const OUTPUT_DIR := "res://artifacts/canonical-office-low-poly"
const CAMERA_NAMES := [
	"MainMenu",
	"TransitionMid",
	"Desk",
...
func _run() -> void:
	...
	for camera_name in CAMERA_NAMES:
		...
		if err != OK:
			...
			print("OFFICE_LOW_POLY_RENDER ", path)
	quit()
